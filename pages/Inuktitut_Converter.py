...
# Bidirectional: Arabic ↔ Inuktitut (South Baffin / Nunavut)
# Base-20 vigesimal. Range: 0–99.
...
<div class="conv-masthead">
    ...
    <div class="conv-masthead-title">Inuktitut Numerals</div>
    <div class="conv-masthead-desc">
        Bidirectional conversion between Arabic numerals and South Baffin Inuktitut —
        vigesimal (base-20) system, Nunavut standard. Range: 0–99.
    </div>
</div>
