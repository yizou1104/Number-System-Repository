...
PROBLEM_DIR = "static/problems"
SOLUTION_DIR = "static/solutions"
                ...
                if submitted:
                    if not (title and selected_tags and problem_file and solution_files):
                        ...
                        for i, sol_file in enumerate(solution_files):
                            ...
                            solution_paths.append(sol_path)
                        ...
                        new_entry = {
                            ...
                            "solution_files": solution_paths  # List of paths
                        }
