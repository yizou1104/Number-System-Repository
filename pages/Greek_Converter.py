...
<div class="conv-caption">
    Implements the Greek numeral system with gender-sensitive hundreds.
    Data from <a href="https://www.omniglot.com/language/numbers/greek.htm" target="_blank">Omniglot</a>.
...
<div class="conv-nav-footer">
    <a class="conv-nav-btn active" href="/Greek_Converter">Greek Converter</a>
    <a class="conv-nav-btn" href="/Greek_Linguistics">Greek Linguistics →</a>
</div>
""", unsafe_allow_html=True)
home_nav()